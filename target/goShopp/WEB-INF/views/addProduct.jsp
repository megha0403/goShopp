	...
	<div class="container">
		...
		<form:form
			...
			<div class="form-group">
				...
				<input path="productName" id="name" class="form-Control" />
			</div>

			<div class="form-group">
				<label for="category">Category</label> <label
					class="checkbox-inline"><radiobutton
						path="productCategory" id="category" value="instrument" />Instrument</label>
				<label class="checkbox-inline"><radiobutton
			...
			<div class="form-group">
				...
				<input type="textarea" path="productDescription" id="description"
					class="form-Control" />
			</div>
			...
			<div class="form-group">
				...
				<input path="productPrice" id="price" class="form-Control" />
			</div>
			...
			<div class="form-group">
				<label for="status">Status</label> <label class="checkbox-inline"><input type="radio"
			...
			<div class="form-group">
				...
				<input path="unitInStock" id="unitInStock" class="form-Control" />
			</div>

			<div class="form-group">
				<label for="manufacturer">Manufacturer</label>
				<input path="productManufacturer" id="manufacturer"
					class="form-Control" />
			</div>
